- [x] Split review into two steps: reviewer generates candidates, verifier confirms only evidence-backed findings.
...
- [x] Add quality filters so generic names like `child`, `result`, `_`, `data`, `params` do not pollute usages or related-test retrieval.
